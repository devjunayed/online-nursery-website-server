...
try {
  ...
  app.post("/products", async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .json(sendResponse(false, "Error creating product", err.message));
    }
  });
  ...
  app.get("/products", async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .json(sendResponse(false, "Error retrieving products", err.message));
    }
  });
  ...
  app.get("/products/:id", async (req, res) => {
    try {
      ...
      res.json(sendResponse(true, "Product retrieved successfully", result));
    } catch (err) {
      res
        .status(500)
        .json(sendResponse(false, "Error retrieving product", err.message));
    }
  });
  ...
  app.delete("/products/:id", async (req, res) => {
    try {
      ...
      res.json(sendResponse(true, "Product deleted successfully", result));
    } catch (err) {
      res
        .status(500)
        .json(sendResponse(false, "Error deleting product", err.message));
    }
  });
  ...
  app.patch("/products/:id", async (req, res) => {
    try {
      ...
      res.json(sendResponse(true, "Product updated successfully", result));
    } catch (err) {
      res
        .status(500)
        .json(sendResponse(false, "Error updating product", err.message));
    }
  });
  ...
  app.get("/category", async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json(sendResponse(false, "Error retrieving categories", err.message));
    }
  });
  ...
  app.delete("/category/:id", async (req, res) => {
    try {
      ...
      res.json(sendResponse(true, "Category deleted successfully", result));
    } catch (err) {
      res
        .status(500)
        .json(sendResponse(false, "Error deleting category", err.message));
    }
  });
  ...
  app.patch("/category/:id", async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json(sendResponse(false, "Error updating category", err.message));
    }
  });
  /*================================================
                      Cart
  ...
  app.post("/cart", async (req, res) => {
    ...
    try {
      ...
      if (
        ...
        return res.json(sendResponse(false, "Insufficient quantity", []));
      }
      ...
      return res.json(sendResponse(true, "Cart created successfully", result));
    } catch (error) {
      console.log(error);
  ...
  app.get("/cart", async (req, res) => {
    try {
      ...
      res.json(sendResponse(true, "All cart retrieved successfully", result));
    } catch (err) {
      res
        .status(500)
        .json(sendResponse(false, "Error retrieving cart", err.message));
    }
  });
  ...
  app.delete("/cart/:id", async (req, res) => {
    try {
      ...
      res.json(sendResponse(true, "Cart deleted successfully", result));
    } catch (err) {
      res
        .status(500)
        .json(sendResponse(false, "Error deleting cart", err.message));
    }
  });
  ...
  app.post("/order", async (req, res) => {
    ...
    try {
      ...
      res.status(500).json(sendResponse(false, "Failed to place order", error));
    }
  });
